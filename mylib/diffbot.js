...
Diffbot.prototype.discussion = function(options, callback) {
    for (var i in options) {
        this[i] = options[i];
    }
    ...
    var diffbot_url = "https://api.diffbot.com/v3/discussion?token=" + this.token + "&url=" + encodeURIComponent(options.uri) + "&format=json";
...
Diffbot.prototype.product = function(options, callback) {
    ...
    var diffbot_url = "https://api.diffbot.com/v3/product?token=" + this.token + "&url=" + encodeURIComponent(options.uri) + "&format=json";
...
Diffbot.prototype.video = function(options, callback) {
    for (var i in options) {
        this[i] = options[i];
    }
    ...
    var diffbot_url = "https://api.diffbot.com/v3/video?token=" + this.token + "&url=" + encodeURIComponent(options.uri) + "&format=json";
